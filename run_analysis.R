...
write.table(df_measurements, "data/results/measurements.txt", row.names = FALSE)
#write.csv(df_measurements_means, "data/results/means_by_activity_subject.csv", row.names = FALSE)
write.table(df_measurements_means, "data/results/means_by_activity_subject.txt", row.names = FALSE)
